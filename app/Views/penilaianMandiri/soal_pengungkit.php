...
<div class="row">
    <div class="demo-vertical-spacing mb-2">
        <div class="progress">
            <div
                class="progress-bar"
                role="progressbar"
    ...
    <div class="col-lg-12 order-0">
        ...
        <button class="btn btn-primary mb-2 unsur-btn">
            Dukungan Sumber Daya Manusia, Akses Data & Informasi, serta Komunikasi
        </button>
        <button class="btn btn-primary mb-2 unsur-btn">
            Pemantauan dan Evaluasi Tata Kelola Organisasi
        </button>
        <button class="btn btn-primary mb-2 unsur-btn">
            Pemantauan dan Evaluasi Manajemen Risiko
        </button>
        <button class="btn btn-primary mb-2 unsur-btn">
