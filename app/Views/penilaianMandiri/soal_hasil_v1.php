...
<script>
    ...
    function handleNextClick() {
        window.location.href = "<?= base_url('/dash_pm?thn=' . $tahun) ?>"; // Ganti dengan URL tujuan
    }

    function handleBackClick() {
        window.location.href = "<?= base_url('/soal_pengungkit?thn=' . $tahun) ?>"; // Ganti dengan URL tujuan
    }
</script>
