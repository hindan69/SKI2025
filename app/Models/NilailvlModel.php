...
class NilailvlModel extends Model
{
    protected $table            = 'nilai_level';
    protected $primaryKey       = 'id';
    protected $useSoftDeletes   = false;
    protected $protectFields    = true;
    protected $allowedFields    = ['id_user', 'id_satker', 'id_pm_satker', 'nilai', 'komenlvl', 'rekomendasi', 'thn_dipa'];
    ...
    public function filter($id_satker, $thn_dipa)
    {
        ...
        $builder = $this->db->table('nilai_level');

        // Pilih kolom yang dibutuhkan
        $builder->select('idx, id_user, id_satker, id_pm_satker, nilai, komenlvl, rekomendasi, thn_dipa, date_created');
